...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupHappyPlacesRecyclerView(happyPlacesList: ArrayList<HappyPlaceModel>) {
        ...
        val placesAdapter = HappyPlacesAdapter(this, happyPlacesList) //display the all da in the recycleview
        ...
        //Step 3: Bind the delete feature class to recyclerview)
        val deleteSwipeHandler = object : SwipeToDeleteCallback(this) {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                // (Step 6: Call the adapter function when it is swiped for delete)
                // START
                val adapter = rv_happy_places_list.adapter as HappyPlacesAdapter
