...
class DatabaseHandler(context: Context) :
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModel): Int {
        ...
        // Updating Row
        val success =
            db.update(TABLE_HAPPY_PLACE, contentValues, KEY_ID + "=" + happyPlace.id, null) //nchof il valeur
        //2nd argument is String containing nullColumnHack
    ...
    // (Step 5: Creating a function to delete the existing happy place detail.)
    // START
    /**
     * Function to delete happy place details.
     */
    fun deleteHappyPlace(happyPlace: HappyPlaceModel): Int {
        val db = this.writableDatabase   //delete tha app we wich
        // Deleting Row
